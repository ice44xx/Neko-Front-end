...
const CategoriesPage = () => {
  ...
  const [animesSubCategory, setAnimesSubCategory] = useState<AnimeType[]>([]);
  ...
  const getSubCategory = async () => {
    ...
    if (res.status === 200) {
      setCategory(res.data);
      setAnimesSubCategory(res.data?.animes || []);
    }
        ...
        <div className={styles.container_master}>
          <div className={styles.container}>
            ...
            <div className={styles.container_animes}>
              {animes || animesSubCategory ? (
                [...animes, ...animesSubCategory].map(anime => (
