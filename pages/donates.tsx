...
const Donates = () => {
  ...
  return (
    <div>
      <Head>
        <title>Neko Animes - Doação</title>
      </Head>
      <main>
        ...
        <div className={styles.container}>
          ...
          <div className={styles.container_donate}>
            <p className={styles.desc}>
              Se você gosta e quer ajudar a manter a neko animes sempre atualizada e com inovações, não deixe de nos ajudar, ficamos eternamente
              gratos
            </p>
            <p className={styles.alert}>
              <span>ATENÇÃO!</span> O doador ou apoiador está ciente que a doação não pode ser devolvida, você NÃO esta comprando ou adquirindo algo e
              sim doando para nos ajudar, e como forma de gratidão iremos fazer um memorial no site dos apoiadores{' '}
            </p>
