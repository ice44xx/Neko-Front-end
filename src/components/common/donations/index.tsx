  ...
  return (
    <div className={styles.container}>
      <div className={styles.container_content}>
        <p>
          Gosta de assistir animes aqui? <br /> Ajude-nos doando QUALQUER valor para apoiar á continuar esse projeto{' '}
          <img src='/assets/heartDonate.png' alt='Coração' className={styles.heart} />
        </p>
