      ...
      <div className={styles.containerImg}>
        ...
        <div className={styles.footer}>
          <p className={styles.desc}>
            Neko animes não hospeda nenhum vídeo em seu servidor. Todo o conteúdo é disponibilizado por terceiros não afiliados. <br />{' '}
            <span>
              <img src='/assets/copyright.png' alt='copyright ' /> 2023 - Neko Animes - Todos os Direitos Reservados
            </span>
          </p>
