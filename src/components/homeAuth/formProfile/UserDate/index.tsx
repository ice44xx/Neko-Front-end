    ...
    return(
        <>  
            <Form className={styles.form} onSubmit={handleUpdate}>
                ...
                <FormGroup className={styles.formgroup}>
                    <Input onChange={(e) => {setBirthday(e.target.value)}} value={formatarData(birthday)} name='firstName' id='firstName' type='text'  className={styles.input}></Input>
                    <Label className={styles.label}>Data de nascimento</Label>
                </FormGroup>

                <FormGroup className={styles.formgroup}>
                    {once ? (
                        <Input onChange={(e) => (setUserName(e.target.value))} disabled value={userName} name='userName' id='userName' type='text' placeholder=' ' className={`${styles.input} ${styles.disabled}`}></Input>
                    ) : (
                        <Input onChange={(e) => (setUserName(e.target.value))} required value={userName} name='userName' id='userName' type='text' placeholder=' ' className={styles.input}></Input>
                    )}
                ...
                <div className={styles.container_submit}>
                    {once ? (
                        <Button onClick={handleKoi} className={styles.btn}>Alterar Nick</Button>
                    ) :  (
                        ''
                    )}
            ...
            <div className={`${styles.koi} ${koi ? styles.koi_active : ''}`}>
                <p onClick={handleKoi}><img src="/assets/fechar.png"/></p>
